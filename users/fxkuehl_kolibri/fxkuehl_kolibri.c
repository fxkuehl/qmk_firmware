...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_SLCK] = ACTION_TAP_DANCE_SAFE_KEY(KC_SCRL),
...
#   define KEYMAP_FN(K35, K36, FNLK) LAYOUT_KOLIBRI_36( \
        SK(F1),  SK(F2),  SK(F3),  SK(F4),  SK(PSCR),KC_APP,  KC_HOME, KC_UP,   KC_END,  TO_MOUS, \
        KC_ESC,  KC_INS,  KC_BSPC, KC_DEL,  KC_ENT,  KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT, FNLK,    \
        LC_F5,   LG_F6,   LA_F7,   SK(F8),  OS_LALT, KC_PGDN, SK(F9),  LA_F10,  RG_F11,  RC_F12,  \
                          _______, MY_CAPS, MY_LOCK, K35,     K36,     _______)
#else
#   define KEYMAP_FN(K35, K36, FNLK) LAYOUT_KOLIBRI_36( \
        TO_MOUS, KC_HOME, KC_UP,   KC_END,  KC_APP,  SK(PSCR),SK(F1),  SK(F2),  SK(F3),  SK(F4), \
        FNLK,    KC_LEFT, KC_DOWN, KC_RGHT, KC_PGUP, KC_ENT,  KC_BSPC, KC_DEL,  KC_INS,  KC_ESC, \
        LC_F5,   LG_F6,   LA_F7,   SK(F8),  KC_PGDN, OS_LALT, SK(F9),  LA_F10,  RG_F11,  RC_F12, \
                          _______, MY_CAPS, MY_LOCK, K35,     K36,     _______)
#endif
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_CONFIG] = LAYOUT_KOLIBRI_RAW_36(
        QK_BOOT, DT_PRNT, DT_DOWN, DT_UP,   DB_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    ...
    [L_MEDIA] = LAYOUT_KOLIBRI_RAW_36(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, M_XARGS, M_EMAIL, KC_SCRL, KC_PAUS,
